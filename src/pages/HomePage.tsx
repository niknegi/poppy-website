        ...
        <div className="mx-auto grid max-w-[1100px] grid-cols-1 items-center gap-16 px-8 md:grid-cols-2">
          <div>
            ...
            <p className="mb-8 max-w-[420px] text-sm leading-relaxed text-muted">
              Poppy records exactly what you do in the browser — clicks, typing, scrolls, even tab
              switches — and turns it into a recipe anyone can run. No coding. No fragile scripts.
              Just show it once.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="#/docs"
                className="inline-flex items-center gap-2 border border-ghost px-7 py-3.5 text-sm font-medium text-bone transition-colors hover:bg-surface-high"
              >
                Read the Docs
              </a>
            </div>
        ...
        <div className="mx-auto max-w-[1100px] px-8">
          <div className="mb-16">
            ...
            <p className="max-w-[500px] text-sm leading-relaxed text-muted">
              We built Poppy because we were tired of explaining the same 14-step process over
              Slack. Now we just send a file.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-px md:grid-cols-3">
            {[
              ...
              >
                ...
                <h3 className="mb-3 text-base font-semibold tracking-tight">{f.title}</h3>
      ...
      <section className="bg-surface-low py-24">
        <div className="mx-auto max-w-[1100px] px-8">
          <div className="mb-16">
            ...
            <p className="max-w-[500px] text-sm leading-relaxed text-muted">
              We deliberately kept the workflow stupidly simple. No setup. No configuration files.
              Just open the sidepanel and go.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  <p className="max-w-[480px] text-sm leading-relaxed text-muted">{s.body}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-surface-low py-24 text-center">
        <div className="mx-auto max-w-[1100px] px-8">
          ...
          <p className="mx-auto mb-8 max-w-[420px] text-sm leading-relaxed text-muted">
            Free. Open source. Takes 30 seconds to install and works on every website.
          </p>
          <a
            href="#"
            className="inline-flex items-center gap-2 bg-gradient-to-br from-primary to-primary-hover px-7 py-3.5 text-sm font-medium text-bone transition-opacity hover:opacity-90"
