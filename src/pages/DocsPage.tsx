...
const sections = [
  ...
  { id: "replay", label: "Replaying a Recipe" },
      ...
      <div className="mx-auto grid max-w-[1100px] grid-cols-1 gap-16 px-8 pt-24 pb-24 md:grid-cols-[220px_1fr]">
        ...
        <article className="max-w-[640px]">
          ...
          <p className="mb-8 text-base leading-relaxed text-muted">
            Poppy is intentionally simple. But simple doesn't mean shallow.
            Here's how to get the most out of it.
          </p>

          <h2
            id="install"
            className="mb-4 mt-12 border-b border-ghost pb-3 font-display text-xl font-bold tracking-tight"
          >
            Installation
          </h2>
          <p className="mb-4 text-sm leading-relaxed text-muted">
            We don't have a Chrome Web Store listing yet (coming soon). For now,
            you load it as an unpacked extension.
          </p>
          <ol className="mb-6 list-decimal pl-5">
            <li className="mb-2 text-sm leading-relaxed text-muted">
              Download zip from the repo and unpack it.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
          ...
          <div className="mb-8 border-l-2 border-primary bg-surface-low p-5">
            ...
            <p className="text-sm text-muted">
              Pin the extension to your toolbar. You'll be opening the sidepanel
              a lot.
            </p>
          </div>
          ...
          <p className="mb-4 text-sm leading-relaxed text-muted">
            Recording is the whole point. Here's how to capture a session
            without messing it up.
          </p>
          <ol className="mb-6 list-decimal pl-5">
            <li className="mb-2 text-sm leading-relaxed text-muted">
              <strong className="text-bone">Open the sidepanel.</strong> Click
              the Poppy icon in your toolbar.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
              <strong className="text-bone">Hit the red circle.</strong> It's in
              the top-right of the sidepanel. You'll see a red "Recording..."
              banner appear.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
              <strong className="text-bone">Do your thing.</strong> Click
              buttons, fill forms, scroll, open tabs. Poppy is watching.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
              <strong className="text-bone">Hit stop.</strong> The red square
              next to the action count. Type a name. Hit save.
            </li>
          </ol>
          ...
          <div className="mb-8 border-l-2 border-primary bg-surface-low p-5">
            ...
            <p className="text-sm text-muted">
              Clicks, text inputs, dropdown selections, scrolls, page
              navigations, and tab events (open, switch, close). We skip
              anything that happens while replaying so you don't get infinite
              loops.
            </p>
          </div>
          ...
          <p className="mb-4 text-sm leading-relaxed text-muted">
            Replaying is where the magic happens. Poppy steps through each
            action with a small delay so you can watch.
          </p>
          <ol className="mb-6 list-decimal pl-5">
            <li className="mb-2 text-sm leading-relaxed text-muted">
              Open the sidepanel and click the film icon to view your recipes.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
              Pick one and click the play button, or open it for details.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
              Hit <strong className="text-bone">Replay</strong>. Poppy will
              switch to the right tabs, click the right elements, and type the
              right text.
            </li>
          </ol>
          ...
          <div className="mb-8 border-l-2 border-primary bg-surface-low p-5">
            ...
            <p className="text-sm text-muted">
              Make sure you're on the right page before replaying. Poppy handles
              navigations, but if your recipe starts mid-flow, you might need to
              get yourself to the starting point first.
            </p>
          </div>
          ...
          <p className="mb-4 text-sm leading-relaxed text-muted">
            Recipes are stored locally in your browser. To share them, you just
            export them.
          </p>
          ...
          <ol className="mb-6 list-decimal pl-5">
            ...
            <li className="mb-2 text-sm leading-relaxed text-muted">
              Hover over a recipe and click the download arrow.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
              A file downloads:{" "}
              <code className="bg-surface-high px-1.5 py-0.5 text-xs text-bone">
                poppy-recipe-name-2026-04-21.poppyrecipe
              </code>
            </li>
          </ol>
          ...
          <ol className="mb-6 list-decimal pl-5">
            <li className="mb-2 text-sm leading-relaxed text-muted">
              Click the <strong className="text-bone">Import</strong> button in
              the recordings list.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
              Select a poppyrecipe file someone sent you.
            </li>
            <li className="mb-2 text-sm leading-relaxed text-muted">
          ...
          <p className="mb-6 text-sm leading-relaxed text-muted">
            We built Poppy for ourselves, but turns out a lot of people have the
            same problem. Here are the workflows we see most.
          </p>
          ...
          <div className="flex flex-col">
            {[
              ...
              <div
                key={u.tag}
                className={`py-8 ${i > 0 ? "border-t border-ghost" : ""}`}
              >
                <div className="mb-3">
          ...
          <h3 className="mb-3 mt-8 text-base font-semibold">
            Does Poppy work on every website?
          </h3>
          <p className="mb-6 text-sm leading-relaxed text-muted">
            Almost. We inject a content script on all URLs, so any standard web
            page is fair game. We skip chrome:// pages, file:// URLs, and other
          ...
          <p className="mb-6 text-sm leading-relaxed text-muted">
            Not in the UI yet. A visual editor is on the roadmap.
          </p>

          <h3 className="mb-3 mt-8 text-base font-semibold">
            Does Poppy store my data?
          </h3>
          <p className="mb-6 text-sm leading-relaxed text-muted">
            Everything stays in your browser. Recipes are stored in IndexedDB.
            We don't have a server, we don't have analytics, and we don't phone
            home. Your data is yours.
          </p>

          <h3 className="mb-3 mt-8 text-base font-semibold">
            What if a replay fails?
          </h3>
          <p className="mb-6 text-sm leading-relaxed text-muted">
            Poppy tries hard to find the right element. If the page has
            completely changed and none of the fallback identifiers work, the
            step will error and replay stops. You'll see what failed in the
            sidepanel.
          </p>
          ...
          <p className="mb-6 text-sm leading-relaxed text-muted">
            The default delay is 500ms between steps. This isn't configurable in
            the UI yet, but it's a single constant in the code if you want to
            tweak it.
          </p>
          ...
          <p className="mb-6 text-sm leading-relaxed text-muted">
            No hard limit. We've tested recordings with 200+ actions.
            Performance depends on your machine and the complexity of the pages
